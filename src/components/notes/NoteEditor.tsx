...
interface NoteEditorProps {
  note: Note;
  onUpdate: (updates: { title?: string; content?: Note['content']; tags?: string[] }) => void;
}
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-950">
      ...
      <input
        ...
        className="w-full bg-transparent text-2xl font-semibold text-zinc-100 placeholder:text-zinc-600 outline-none px-8 pt-6 pb-2"
      />
